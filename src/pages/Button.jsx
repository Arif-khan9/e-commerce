...
const Button = () => {
  return (
     ...
     <div className='flex justify-center'>
        <div className='text-white bg-blue-950 py-2 rounded-2xl text-2xl text-center w-180'>SALES UPTO 50%</div>
        
     </div>
     <div className='flex justify-center mt-10'>
        <img className='h-140 w-250 shadow-2xl object-contain' src={clothes} alt="" />
     </div>
     </>
  )
}
